...
export const META: Record<string, ComponentMetadata> = {
  ...
  icon:       { label:"Icon",       tag:"div",     cat:"Basic",      icon:"✦",  color:"#f59e0b", content:"user" },
...
export const LIB: LibraryCategories = {
  ...
  Basic:      ["text","heading","image","button","input","icon","card"],
...
export const DEF: DefaultStyles = {
  ...
  navbar:     { width:"100%", height:"64px", backgroundColor:"transparent", display:"flex", alignItems:"center", padding:"0 24px", gap:"16px" },
  sidebar:    { width:"240px", minHeight:"400px", backgroundColor:"transparent", padding:"16px" },
  footer:     { width:"100%", height:"80px", backgroundColor:"transparent", display:"flex", alignItems:"center", padding:"0 24px" },
  text:       { fontSize:"14px", color:"#e0e0e0", lineHeight:"1.6" },
  heading:    { fontSize:"28px", fontWeight:"700", color:"#ffffff", lineHeight:"1.2" },
  image:      { width:"200px", height:"150px", backgroundColor:"transparent", borderRadius:"8px" },
  ...
  icon:       { fontSize:"24px", color:"#ffffff", display:"inline-flex", alignItems:"center", justifyContent:"center", width:"24px", height:"24px" },
